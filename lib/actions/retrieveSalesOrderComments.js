...
async function exec(msg, cfg) {
    ...
    const response = await service.get(
        `${baseUrl}/orders/${msg.body.path.id}/comments`
    );
...
exports.getMetaModel = async function getMetaModel(cfg) {
    return await getMetaModelHelper(cfg, './lib/schemas/retrieveSalesOrderComments.in.json',
        './lib/schemas/retrieveSalesOrderComments.out.json');
};
