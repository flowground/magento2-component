...
async function exec(msg, cfg) {
    ...
    const response = await service.delete(
        `${baseUrl}/products/${msg.body.path.sku}/websites/${msg.body.path.websiteId}`
    );
...
exports.getMetaModel = async function getMetaModel(cfg) {
    return await getMetaModelHelper(cfg, './lib/schemas/unassignProductFromWebsite.in.json',
        './lib/schemas/unassignProductFromWebsite.out.json');
};
