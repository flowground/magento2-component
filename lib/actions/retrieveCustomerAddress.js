...
async function exec(msg, cfg) {
    ...
    const response = await service.get(
        `${baseUrl}/customers/addresses/${msg.body.path.addressId}`
    );
...
exports.getMetaModel = async function getMetaModel(cfg) {
    return await getMetaModelHelper(cfg, './lib/schemas/retrieveCustomerAddress.in.json',
        './lib/schemas/retrieveCustomerAddress.out.json');
};
