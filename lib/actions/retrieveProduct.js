...
// exports.getMetaModel = async function() {
//     const outMetadataString = await fs.readFile('./lib/schemas/retrieveProduct.out.json');
//     const inMetadataString = await fs.readFile('./lib/schemas/retrieveProduct.in.json');
//
//     const metadata = {
//         in: JSON.parse(inMetadataString),
//         out: JSON.parse(outMetadataString)
//     };
//
//     return metadata;
// };
exports.getMetaModel = function getMetaModel(cfg, cb) {
    ...
    inputMeta.properties.path.properties.store["enum"] = ["all","default"];
